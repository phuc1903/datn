...
@section('content')
    <h1 class="mb-5 text-dark-custom">Cài đặt Logo</h1>
                ...
                <div class="body">
                    <form action="{{ route('admin.setting.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <x-image.index id="image-header-light" class="mb-3 img-fluid"
                            style="width: 300px; height: 300px;" :src="isset($logoHeaderLightMode) ? asset($logoHeaderLightMode) : config('settings.image_default')"
                            alt="Logo Header Light Mode" />
                        <x-button.index label="Tải ảnh" onclick="chooseImage('image-header-light')" color="outline" />
                        <x-form.input_text hidden id="file-image-header-light" onchange="previewImage(this, 'image-header-light');" type="file"
                ...
                <div class="body">
                    <form action="{{ route('admin.setting.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <x-image.index id="image-header-dark" class="mb-3 img-fluid"
                            style="width: 300px; height: 300px;" :src="isset($logoHeaderDarkMode) ? asset($logoHeaderDarkMode) : config('settings.image_default')"
                            alt="Logo Header Dark Mode" />
                        <x-button.index label="Tải ảnh" onclick="chooseImage('image-header-dark')" color="outline" />
                        <x-form.input_text hidden id="file-image-header-dark" onchange="previewImage(this, 'image-header-dark');" type="file"
                ...
                <div class="body">
                    <form action="{{ route('admin.setting.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <x-image.index id="image-footer-light" class="mb-3 img-fluid"
                            style="width: 300px; height: 300px;" :src="isset($logoFooterLightMode) ? asset($logoFooterLightMode) : config('settings.image_default')"
                            alt="Logo Footer Light Mode" />
                        <x-button.index label="Tải ảnh" onclick="chooseImage('image-footer-light')" color="outline" />
                        <x-form.input_text hidden id="file-image-footer-light" onchange="previewImage(this, 'image-footer-light');" type="file"
                ...
                <div class="body">
                    <form action="{{ route('admin.setting.store')}}" method="post" enctype="multipart/form-data">
                        ...
                        <x-image.index id="image-footer-dark" class="mb-3 img-fluid"
                            style="width: 300px; height: 300px;" :src="isset($logoFooterDarkMode) ? asset($logoFooterDarkMode) : config('settings.image_default')"
                            alt="Logo Footer Dark Mode" />
                        <x-button.index label="Tải ảnh" onclick="chooseImage('image-footer-dark')" color="outline" />
                        <x-form.input_text hidden id="file-image-footer-dark" onchange="previewImage(this, 'image-footer-dark');" type="file"
